...
export default function Followups() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Today's Follow-ups</h1>
        <p className="text-gray-500 mt-1">{followups.length} follow-up{followups.length !== 1 ? 's' : ''} due today</p>
      </div>
      ...
      <div className="bg-white rounded-xl border">
        {followups.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h3 className="font-medium text-gray-900">No follow-ups today</h3>
              ...
              return (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">{fu.note}</p>
